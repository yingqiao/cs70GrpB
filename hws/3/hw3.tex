...
In this problem, we will consider an ongoing war with ninjas and a massive four-headed dragon. 
The four heads of the dragon are fair to each other: 
they will only eat if each of them have an equal share. 
One of the heads is compassionate. 
...
When there are an odd number of ninjas, the ninjas see this as their time to pounce. 
...
\ifsolutions
\textbf{Solutions:} There are two solutions. 
Either Man 3's 2nd and 3rd preference can be switched or Woman C's 1st and 2nd preferences can be switched. 
If either of these happens we will get no rogue couples.
\fi
