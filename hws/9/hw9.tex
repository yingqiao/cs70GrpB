...
\end{itemize}  
Thus our final answer is $\binom{10}{3} + 2*\binom{10}{2} + \binom{10}{1}$
...
\end{itemize}
Thus our final answer is $\binom{10}{3} + 3*\binom{10}{2} + 3*\binom{10}{1} +\binom{10}{0}$
...
$$= \binom{10}{5} \ + \ \binom{10}{4}*5 \ + \ \binom{10}{3} *10 \ + \binom{10}{2} *10\  + \ \binom{10}{1}*5$$


An alternate form of this would be

$$\binom{10}{5} \ + \ \binom{10}{4}* (\binom{4}{1} + \binom{4}{0}) \ + \ \binom{10}{3} * (\binom{3}{2} + 2*\binom{3}{1} + \binom{3}{0}) \ + \ \binom{10}{2} * (\binom{4}{1} + \binom{4}{1} +\binom{2}{1} + \binom{1}{1}) \ + \ \binom{10}{1}(1+1+1+1+1) $$


%other scratch work.
$$1 + 2*\binom{3}{1} + \binom{3}{2}) \ + \binom{10}{2} * (2 + 4*\binom{2}{1} )\  + \ \binom{10}{1}*5$$

$$ \binom{10}{5} \ + \  [\binom{4}{0}+\binom{4}{1}]\binom{10}{4} +  [1+ 2\binom{3}{1} + \binom{3}{2}] \binom{10}{3} + [1+ 3*\binom{2}{1} + 3*\binom{2}{2}  ]\binom{10}{2} + 5*\binom{10}{1} + \binom{10}{0}$$
