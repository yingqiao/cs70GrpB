...
$= gcd(128, 56)$   [$56 = 440 \mod {128} = 440 - \ [?] \times 128$]  \ifsolutions $[?] = 3$ \fi

$= gcd(56, 16)$ \ \  [$16 = 128 \mod{56} = 128 - \ [?] \times 56$]   \ifsolutions $[?] = 2$ \fi

$= gcd(16, 8)$  \ \ [$8 = 56 \mod{16} = 56 - \ [?] * 16$] \ifsolutions $[?] = 3$ \fi

$= gcd(8, 0)$  \ \ [$0 = 16 \mod{8} = 16 - 2 \times 8$]
...
$= \ [?] \  \times 2328 + \ [?] \ * 440$ \ifsolutions{$31 \times 2328 - 164 \times 440$} \fi
...
\item What does this imply, in this case, about the multiplicative inverse of $17$, in arithmetic mod $38$? \ifsolutions{It is equal to -29, which is equal to 9} \fi
\end{enumerate}
