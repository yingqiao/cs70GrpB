...
\item Prove that if you put $n+1$ apples into $n$ boxes, any way you like, then at least one box must contain at least 2 apples.  This is known as the {\em pigeonhole principle}. \\
...
\item Prove that the length of the hypotenuse of a non-degenerate right triangle is strictly less than the sum of the two remaining sides.
\begin{enumerate}
