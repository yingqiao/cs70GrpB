...
\begin{enumerate}
\item[i.] Note that if you create a $2$-sided die, this is the exact same thing as counting number of heads in coin flips. Therefore, you would expect all the previous parts to look the same. Repeat 1. parts iii. and iv. above with a $2$-sided dice.
